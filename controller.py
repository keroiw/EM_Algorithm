...
def repeat_experiment(source_file: str, dest_file: str, reps=3, max_rep=1000, est_alpha="no"):
    theta_a_lst = []
    theta_b_lst = []
    ...
    for i in range(reps):
        ...
        theta_a, theta_b, alpha_1, counter = init_em(X, max_rep, est_alpha=est_alpha, alpha=0.5)
